...
# Phase 1: Easy / Medium / Hard
DATASETS=(oxford_flowers dtd eurosat)
...
echo "Running Exp1 (FixedUniquePatches) CD benchmark for dataset: $DATASET (array task $SLURM_ARRAY_TASK_ID)"
