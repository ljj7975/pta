...
# 7 datasets that are ready (food101 + stanford_cars excluded — not yet downloaded)
...
echo "Running MultiProtoPTA CD benchmark for dataset: $DATASET (array task $SLURM_ARRAY_TASK_ID)"
