...
def main() -> None:
    ...
    parser.add_argument("--file", default="outputs/proto_zscore_results.txt")
    parser.add_argument("--methods", nargs="*", help="filter by method name substring")
    parser.add_argument("--ignore-datasets", nargs="*", help="datasets to exclude from the table (e.g., ucf101 dtd)", default=["ucf101", "caltech101", "fgvc"])
    parser.add_argument("--out", default="outputs/proto_zscore_exp_results.txt", help="output file (overwritten)")
